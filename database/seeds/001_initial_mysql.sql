...
values ('Administrador', 'admin@central.local', '$2y$10$aFv1sdCp40DrZQDnKJC/D.FVfs5qJTHRwn1E5bzG36yS.K3QS.uzG', 'owner', 1);

insert into vendors (name, email, commission_default_percent, active)
values ('Vendedor exemplo', 'vendedor@central.local', 10.00, 1);

insert into saas_systems (name, slug, base_url, database_type, active)
values ('Sistema exemplo', 'sistema-exemplo', 'https://app.exemplo.com', 'mariadb', 1);

insert into plans (system_id, name, billing_cycle, price, active)
values (1, 'Plano Mensal', 'monthly', 99.90, 1);
